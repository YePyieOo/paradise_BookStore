               ...
               <div class="col-12 col-md-12 col-lg-4">
                  <div class="my-card m-5 border border-primary rounded-2">
                     ...
                     <div class="my-card-info">
                        ...
                        <div class="text-primary mb-2 shop_info">U Tun Lin Chan,Hlae Tan ,Kamayout,Yangon</div>
                        <div class="text-primary mb-2 shop_info">097665577,0876567899</div>
                        <a class=" mb-2 shop_info">www.yarpyae.com</a>
                     </div>
                  </div>
               </div>
            <?php endfor ?>
